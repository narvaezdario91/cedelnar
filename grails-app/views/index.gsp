...
<head>
	...
	<asset:link rel="shortcut icon" href="magister/images/gt_favicon.png"/> 
	
	<!-- Bootstrap itself -->
	<asset:stylesheet src="bootstrap/dist/css/bootstrap.min.css"/>

	<!-- Custom styles -->
	<asset:stylesheet src="magister/css/magister.css"/>
	...
	<div class="container">
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
				<li><a href="#head" class="active">Bienvenido</a></li>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 text-center">	
				...
				<h1 class="title">Cedelnar</h1>
				<h2 class="subtitle">Cooperativa Financiera Familiar</h2>
...
<section class="section" id="themes">
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-4 col-sm-offset-2">
				<div class="thumbnail">
					<asset:image src="magister/screenshots/sshot1.jpg" alt=""/>
					<div class="caption">
			...
			<div class="col-sm-4">
				<div class="thumbnail">
					<asset:image src="magister/screenshots/sshot4.jpg" alt=""/>
					<div class="caption">
						<h3>Thumbnail label</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque doloribus enim vitae nam cupiditate eius at explicabo eaque facere iste.</p>
						<p><a href="#" class="btn btn-primary" role="button">Button</a> <a href="#" class="btn btn-default" role="button">Button</a></p>
			...
			<div class="col-sm-4 col-sm-offset-2">
				<div class="thumbnail">
					<asset:image src="magister/screenshots/sshot5.jpg" alt=""/>
					<div class="caption">
						<h3>Thumbnail label</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque doloribus enim vitae nam cupiditate eius at explicabo eaque facere iste.</p>
						<p><a href="#" class="btn btn-primary" role="button">Button</a> <a href="#" class="btn btn-default" role="button">Button</a></p>
			...
			<div class="col-sm-4">
				<div class="thumbnail">
					<asset:image src="magister/screenshots/sshot3.jpg" alt=""/>
					<div class="caption">
						<h3>Thumbnail label</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque doloribus enim vitae nam cupiditate eius at explicabo eaque facere iste.</p>
						<p><a href="#" class="btn btn-primary" role="button">Button</a> <a href="#" class="btn btn-default" role="button">Button</a></p>
...
<asset:javascript src="magister/js/modernizr.custom.72241.js"/>
<!-- Custom template scripts -->
<asset:javascript src="magister/js/magister.js"/>
</body>
</html>